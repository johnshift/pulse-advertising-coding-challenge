...
export const TopPostCard = ({ post, onClick }: TopPostCardProps) => {
  ...
  return (
    <Card
      className={cn(
        'relative overflow-hidden border-emerald-500/20 bg-linear-to-br from-card to-emerald-500/5 md:col-span-2 lg:col-span-1 lg:gap-4',
...
export const TopPostCardEmpty = () => {
  return (
    <Card className='relative overflow-hidden border-emerald-500/20 bg-linear-to-br from-card to-emerald-500/5 md:col-span-2 lg:col-span-1'>
      <div className='absolute top-4 right-4 rounded-lg bg-emerald-500/10 p-2'>
        <Crown className='size-5 text-emerald-500' aria-hidden='true' />
      </div>
